...
# titanic_with_kedro documentation build
...
from titanic_with_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "titanic_with_kedro"
copyright = "2018-2019, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "titanic_with_kedrodoc"
...
latex_documents = [
    (
        master_doc,
        "titanic_with_kedro.tex",
        "titanic_with_kedro Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "titanic_with_kedro",
        "Project titanic_with_kedro codebase.",
        "Data-Science",
    )
]
